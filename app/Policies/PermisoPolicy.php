...
class PermisoPolicy
{
    ...
    {
        return $user->hasPermiso('acceso-permiso');
    ...
    {
        return $user->hasPermiso('visualizar-permiso');
    }
    ...
    {
        return $user->hasPermiso('crear-permiso');
    }
    ...
    {
        return $user->hasPermiso('editar-permiso');
    }
    ...
    {
        return $user->hasPermiso('eliminar-permiso');
    }
